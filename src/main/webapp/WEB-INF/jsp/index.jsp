...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> 文件系统</h1>
          <p>在云端轻松管理您的文件</p>
        </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">为何选择我们</h3>
            <ul>
              <li>这可不仅仅是一个课设。</li>
              <li>它可以成为您的资深文件管家</li>
              <li>更可以作为一款不错的组织内交流云盘</li>
              <li>您可以上传各类的文件</li>
              <li>在保障个人文件安全的前提下</li>
              <li>你可以将自己的文件共享给他人</li>
              <li>大家都可以把文件投入共享池</li>
              <li>严格区分共享和私人领域</li>
              <li>这里是为您量身定制的文件系统</li>
            </ul>
          </div>
        </div>
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">活跃用户</h3>
